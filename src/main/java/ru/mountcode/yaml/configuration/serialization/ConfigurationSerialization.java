package ru.mountcode.yaml.configuration.serialization;
...
/**
 * Utility class for storing and retrieving classes for {@link ru.mountcode.yaml.configuration.Configuration}.
 */
