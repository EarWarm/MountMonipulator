...
public final class Access {
  ...
  /**
   * Tells whether a given access modifier is synthetic. A modifier is synthetic if it is marked with the ACC_SYNTHETIC
   * flag (0x1000), as specified in JLS8, 4 .6 <tt>Methods</tt>.
   *
   * @param mod The access modifier to check
  ...
  /**
   * Tells whether a given access modifier is bridge. A modifier is bridge if it is marked with the ACC_BRIDGE flag
   * (0x0040), as specified in JLS8, 4.6
   * <tt>Methods</tt>.
   *
   * @param mod The access modifier to check
  ...
  /**
   * Tells whether a given access modifier is synchronized. A modifier is synchronized if it is marked with the
   * ACC_SYNCHRONIZED flag (0x0020), as specified in JLS8, 4.6
  ...
  /**
   * Tells whether the given method signature is generic. The method is considered generic if its signature ends with
   * something along the lines of ")TV;"
   *
